        ...
        >
          <div className="flex items-center justify-center h-full px-8">
            <div className="text-center text-white max-w-3xl">
              <h1 className="font-serif text-5xl md:text-7xl font-normal leading-tight mb-6 animate-fade-in-up">
                {slide.title}
              </h1>
              <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto mb-8 animate-fade-in-up animation-delay-300">
                {slide.description}
              </p>
              <Button className="bg-[#9B2B3A] hover:bg-[#8a2533] text-white px-8 py-6 text-lg animate-fade-in-up animation-delay-600">
                Learn More
              </Button>
            </div>
          </div>
